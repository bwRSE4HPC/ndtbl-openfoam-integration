...
usage() {
    cat <<'EOF'
Usage:
  run_baseline_benchmarks.sh [options]
...
Examples:
  ./run_baseline_benchmarks.sh --resolution 21 --resolution 31
  ./run_baseline_benchmarks.sh --resolution 21 --mpi none --mpi 2 --mpi 4 --mpi 8
EOF
}
